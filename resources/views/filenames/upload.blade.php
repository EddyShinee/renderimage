...
<input type="hidden" name="_token" value="{{ Session::token() }}">
      <div class="form-group">
        <label for="exampleFormControlFile1">Tên file name</label>
        <input class="form-control" type="text" name='name' placeholder="Tên file name">
      </div>
        <div class="form-group">
        <label for="exampleFormControlFile1">Chọn file name</label>
